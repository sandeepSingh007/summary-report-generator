...
COPY summary-report-generator-v4.html /usr/local/apache2/htdocs/
...
RUN sed -i 's/Listen 80/Listen 8080/' /usr/local/apache2/conf/httpd.conf && \
    sed -i 's|DirectoryIndex index.html|DirectoryIndex summary-report-generator-v4.html|' /usr/local/apache2/conf/httpd.conf && \
